...
RSpec.describe User, type: :model do
  describe 'Validations' do
    ...
    it 'should not be valid with a password shorter than 6 characters' do
      @user = User.new({ first_name: 'John', last_name: 'Doe', email: 'john@example.com', password: 'hi', password_confirmation: 'hi' })
    ...
    it 'should not be valid if password confirmation does not match password' do
      @user = User.new({ first_name: 'John', last_name: 'Doe', email: 'john@example.com', password: 'password', password_confirmation: 'passwor'})
